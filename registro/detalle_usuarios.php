...
<table class="table table-hover table-condensed" style="font-size: small" id="usuarios">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo strtoupper($fila['nombre_usuario']) ?></td>
            <td><?php echo $fila['clave'] ?></td>                
            <td><?php echo  strtoupper($fila['estado']) ?></td>
            <td>
                <?php
                if( $_SESSION['id_usuario'] == 2){
                ?>
                <select name="id_tipo" id="id_tipo" class="form-control" onchange="cambiar_permiso(<?php echo $fila['id_usuario'] ?>,this.value)">
            ...
            <td>
                ...
                if( $_SESSION['id_usuario'] == 2){
                ?>
                <a href="#" onclick="borrar_usuario(<?php echo  $fila['id_usuario'] ?>, '<?php echo  $fila['apellido'].', '.$fila['nombres'] ?>')">
