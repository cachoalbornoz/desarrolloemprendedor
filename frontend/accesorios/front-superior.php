		...
		<div class="container">
			...
			?>
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					...
					<ul class="navbar-nav nav-fill">
						<li class="nav-item">
							<a class="nav-link" href="/desarrolloemprendedor/frontend/registro_edita.php?id_solicitante=<?php echo $_SESSION['id_usuario'] ?>">
								Mis datos
							</a>
						</li>	
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" href="#" onClick="salida()" title="Salir">
								<?php echo ucwords(strtolower($_SESSION['nombres'].' '.$_SESSION['apellido']))  ; ?> 
