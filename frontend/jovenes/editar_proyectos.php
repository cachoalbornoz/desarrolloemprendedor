...
mysqli_query($con, "UPDATE registro_solicitantes SET id_rubro = $id_rubro, id_medio = $id_medio, observaciones = '$observaciones' WHERE id_solicitante = $id_solicitante");
...
$edicion = "UPDATE proyectos SET monto=$monto, denominacion = '$denominacion',resumen_ejecutivo = '$resumen_ejecutivo',
...
latitud = $latitud, longitud = $longitud WHERE id_proyecto = $id_proyecto";
