...
$apellido      = $registro_solicitantes['apellido'];
$nombres       = $registro_solicitantes['nombres'];
$facebook      = strlen(trim($registro_solicitantes['facebook'])  < 10) ? null : trim($registro_solicitantes['facebook']);
$instagram     = strlen(trim($registro_solicitantes['instagram']) < 10) ? null : trim($registro_solicitantes['instagram']);
$genero        = $registro_solicitantes['genero'];
$otrogenero    = $registro_solicitantes['otrogenero'];
$email         = $registro_solicitantes['email'];
$cuit          = $registro_solicitantes['cuit'];
...
$tabla_registro = mysqli_query(
    $con,
    "SELECT * FROM registro_solicitantes WHERE id_solicitante = $id_solicitante"
);
...
<form name="formsolicitantedit" id="formsolicitantedit">
    ...
    <div class="card mb-2">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <input id="id_solicitante" name="id_solicitante" type="hidden" value="<?php print $id_solicitante; ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-2 p-3">
                    <label>DNI</label>
                    <input id="dni" name="dni" type="text" autofocus="true" class="form-control" value="<?php print  $dni; ?>" required>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-4 p-3">
                    <label>Apellido</label>
                    <input id="apellido" name="apellido" type="text" class="form-control mayus" value="<?php print  $apellido; ?>" required>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-6 p-3">
                    <label>Nombres</label>
                    <input id="nombres" name="nombres" type="text" class="form-control mayus" value="<?php print  $nombres; ?>" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-6 p-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="email" type="email" id="email" class="form-control minus" value="<?php print $email; ?>" required maxlength="150">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-6 p-3">
                    ...
                    <input name="cuit" type="number" id="cuit" class="form-control" value="<?php print  $cuit; ?>" required maxlength="11">
                </div>
                <div class="col-xs-12 col-md-6 col-lg-6 p-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="date" id="fecha_nac" name="fecha_nac" class="form-control text-center" required value="<?php print $fecha_nac; ?>">
                    </div>
                </div>
            </div>
    ...
    print 'checked';
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 mb-4">
                    <input id="otrogenero" name="otrogenero" value="<?php print $otrogenero; ?>" type="text" class="form-control shadow <?php if ($genero == 0 or $genero == 1) {
    print 'd-none';
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="facebook" name="facebook" type="text" class="form-control shadow" value="<?php print $facebook; ?>" required>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="instagram" name="instagram" type="text" class="form-control shadow" value="<?php print  $instagram; ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12 p-3">
                    ...
                    <input id="direccion" name="direccion" type="text" class="form-control mayus" value="<?php print  $direccion; ?>" required maxlength="150">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-6 p-3">
                    ...
                    <select name="departamento" id="departamento" onchange="from(this.value,'ciudad','ciudades.php')" class="form-control" required>
                        <option value="<?php print $id_departamento; ?>" selected><?php print  $departamento; ?>
                        </option>
                        <?php
                ...
                <div class="col-xs-12 col-md-6 col-lg-6 p-3">
                    ...
                    <div id="ciudad">
                        <select name="id_ciudad" id="id_ciudad" class="form-control" required>
                            <option value="<?php print  $id_ciudad; ?>" selected><?php print  $ciudad; ?>
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-4 p-3">
                    <div class="input-group mb-3">
                        ...
                        <input id="cod_area" name="cod_area" type="number" value="<?php print $cod_area; ?>" class="form-control" maxlength="5" required placeholder="Ej 343">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-md-12 col-lg-4 p-3">
                    <div class="input-group mb-3">
                        ...
                        <input id="celular" name="celular" type="text" value="<?php print  $celular; ?>" class="form-control" required>
                    </div>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-4 p-3">
                    <div class="input-group mb-3">
                        ...
                        <input id="telefono" name="telefono" type="text" class="form-control" value="<?php print $telefono; ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-body border border-info">
                ...
                <div class="row mb-4">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <select name="id_rubro" id="id_rubro" class="form-control" size="9" required>
                            ...
                            while ($fila = mysqli_fetch_array($registro)) {
                                if ($fila[0] == $id_rubro) {
                                    print '<option value=' . $id_rubro . " selected \>" . $fila['rubro'] . '</option>';
                                } else {
                                    print '<option value=' . $fila[0] . '>' . $fila['rubro'] . '</option>';
                                }
                            }
                            ?>
                        </select>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="form-check mb-4 ml-3 mr-3">
                            <input class="form-check-input programa" name="id_programa[]" type="checkbox" <?php print $checked; ?> value="<?php print $id_programa; ?>" id="programaCheck<?php print $contador; ?>">
                            <label class="form-check-label" for="programaCheck<?php print $contador; ?>">
                                <?php print $fila['programa']; ?>
                            </label>
                        </div>
                ...
                <div class="row pt-5 pb-5">
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                        ...
                        <textarea name="idea" id="idea" class="form-control" title="Describa las cualidades principales. Máx 1800 caracteres" required><?php print $texto_observaciones; ?></textarea>
                    </div>
                </div>
                ...
                <div id="empresa" <?php if ($id_empresa == 0) {
                                ...
                                print 'class="card card-body border border-info"';
                            } ?>>

                    <div class="row pt-3 pb-2">
                        <div class="col">
                            <label>Nombre de la Empresa o Razón Social</label>
                            <input name="id_empresa" id="id_empresa" type="hidden" value="<?php print $id_empresa; ?>">
                            <input name="razon_social" id="razon_social" type="text" class="form-control" value="<?php print $razon_social; ?>">
                        </div>
                        <div class="col">
                            <label>Nro de CUIT</label>
                            <input name="cuite" type="text" id="cuite" class="form-control" maxlength="11" value="<?php print $cuite; ?>" placeholder="Ingrese Nro sin puntos">
                        </div>
                        <div class="col">
                            ...
                            <select id="id_tipo_sociedad" name="id_tipo_sociedad" size="1" class="form-control">
                                ...
                                while ($fila = mysqli_fetch_array($registro)) {
                                    if ($fila[0] == $id_tipo_sociedad) {
                                        print '<option value=' . $id_tipo_sociedad . " selected \>" . $sociedad . "</option>\n";
                                    } else {
                                        print '<option value=' . $fila[0] . '>' . $fila[1] . "</option>\n";
                                    }
                                }
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="domiciliol" id="domiciliol" value="<?php print $domiciliol; ?>" class="form-control">
                        </div>
                        <div class="col">
                            <label>Nro</label>
                            <input type="text" name="nrol" id="nrol" value="<?php print $nrol; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>Departamento</label>
                            <select name="departamentol" id="departamentol" onchange="from(this.value,'ciudadl','ciudades.php')" class="form-control">
                            ...
                            while ($fila = mysqli_fetch_array($registro)) {
                                if ($fila[0] == $id_departamentol) {
                                    print '<option value=' . $id_departamentol . " selected \>" . $departamentol . "</option>\n";
                                } else {
                                    print '<option value=' . $fila[0] . '-id_ciudadl' . '>' . $fila[1] . '</option>';
                                }
                            }
                            ?>
                            </select>
                        ...
                        <div class="col">
                            ...
                            <div id="ciudadl">
                                <select name="id_ciudadl" id="id_ciudadl" class="form-control">
                                    <option value="<?php print $id_ciudadl; ?> " selected><?php print $ciudadl; ?>
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input name="representante" type="text" id="representante" value="<?php print $representante; ?>" class="form-control" placeholder="Datos del representante">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="domicilior" id="domicilior" value="<?php print $domicilior; ?>" class="form-control">
                        </div>
                        <div class="col">
                            <label>Nro</label>
                            <input type="text" name="nror" id="nror" value="<?php print $nror; ?>" class="form-control">
                        </div>
                    </div>
                            ...
                            <select name="departamentor" id="departamentor" onchange="from(this.value,'ciudadr','ciudades.php')" class="form-control">
                                ...
                                while ($fila = mysqli_fetch_array($registro)) {
                                    if ($fila[0] == $id_departamentor) {
                                        print '<option value=' . $id_departamentor . " selected \>" . $departamentor . "</option>\n";
                                    } else {
                                        print '<option value=' . $fila[0] . '-id_ciudadr' . '>' . $fila[1] . '</option>';
                                    }
                                }
                                ?>
                            </select>
                        ...
                        <div class="col">
                            ...
                            <div id="ciudadr">
                                <select name="id_ciudadr" id="id_ciudadr" class="form-control">
                                    <option value="<?php print $id_ciudadr; ?> " selected><?php print $ciudadr; ?>
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            <input name="codigoafip" type="text" id="codigoafip" value="<?php print $codigoafip; ?>" class="form-control">
                        </div>
                        <div class="col-lg-4">
                            <label>Actividad Codigo Afip</label>
                            <input name="actividadafip" type="text" id="actividadafip" value="<?php print $codigoafip; ?>" class="form-control">
                        </div>
                        <div class="col-lg-3">
                            <label>Fecha Inscripción</label>
                            <input type="date" name="fecha_inscripcion" id="fecha_inscripcion" value="<?php print $fecha_inscripcion; ?>" class="form-control">
                        </div>
                        <div class="col-lg-3">
                            <label>Fecha Inicio Actividad</label>
                            <input type="date" name="fecha_inicio" id="fecha_inicio" value="<?php print $fecha_inicio; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <input name="otrosregistros" id="otrosregistros" type="text" value="<?php print $otrosregistros; ?>" class="form-control" placeholder="Indique en que otros organismos, ej. ATER, Municipalidad, Otros.">
                        </div>
                        <div class="col-lg-3">
                            <label> Nro Exportador, si lo es.</label>
                            <input name="nroexportador" id="nroexportador" type="text" value="<?php print $nroexportador; ?>" class="form-control">
                        </div>
                    </div>
