...
?> 
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-6">
                    <b><?php print $_SESSION['titular']; ?> </b> - Notificaciones
                </div>  
                <div class="col-6">    
        ...
        <div class="card-body">
            ...
            <div class="row m-3">
                <div class="col-xs-12 col-sm-12 col-lg-2">
                    Fecha <input type="date" id="fecha" name="fecha" required class="form-control" value="<?php echo date('Y-m-d');?>">
                </div>
            </div>    
            <div class="row m-3">
                <div class="col-xs-12 col-sm-12 col-lg-3">
                    ...
                    ORDER BY rel.id_responsabilidad DESC, emp.apellido ASC, emp.nombres ASC"); 
    ...
    while($fila = mysqli_fetch_array($tabla_emprendedores)) {?>
                            <option value="<?php print $fila[0]; ?>"><?php print $fila[1] . ', ' . $fila[2]; ?></option>
                        <?php
    }
?>
                    </select>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-3">
                    Parentesco / relación con el proyecto
...
while($fila = mysqli_fetch_array($tabla)) {?>
                        <option value="<?php print $fila[0]; ?>"><?php print $fila[1]; ?></option>
                        <?php
}
?>    
                    </select>
...
?>  
                ...
                <div class="col-xs-12 col-sm-12 col-lg-3">
                    $ monto
                    <input type="text" id="monto" name="monto" class="form-control" value="0">
                </div>
...
<script type="text/javascript">
    ...
    function mover(){
        ...
        $("#detalle_notificacion").load('detalle_notificacion.php', {operacion:1, 
            fecha, apellido, dni, id_emprendedor, id_parentesco, id_tipo_postal, id_notificacion, monto }
        );
