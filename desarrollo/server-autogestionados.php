...
$sql =
    "SELECT t1.id_solicitante, concat(t1.apellido, ', ', t1.nombres) AS solicitante, t1.fecha, t1.dni, t1.email, t1.cod_area, t1.celular, t4.nombre as ciudad, t5.nombre AS dpto, t2.observaciones as resena, rubro, t10.estado, t10.icono, if(habilitado=1,'SI',if(habilitado=0,'NO','NO')) as habilitado, t9.fecha as fechar, t2.observacionesp, abreviatura, forma, entidad, t8.id_estado
...
while ($row  = mysqli_fetch_array($query)) {
    ...
    $subdata[]  = $cont . ' - ' . '<a href="javascript:void(0)" title="Elimina solicitante"><i class="fas fa-trash text-danger borrar" id="' . $row['id_solicitante'] . '"></i></a>';
