...
$tabla_emprendedores = mysqli_query(
    $con,
    "SELECT * 
    FROM emprendedores emp
    INNER JOIN rel_expedientes_emprendedores rel ON emp.id_emprendedor = rel.id_emprendedor
    WHERE emp.id_emprendedor = '$id_emprendedor'"
) or die('Error leer emprendedores');
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form method="post" name="emprendedor" id="emprendedor" action="editar_emprendedor.php?id=<?php print $id_emprendedor; ?>">
      ...
      <div class="row m-3">
        <div class="col-xs-12 col-sm-12 col-lg-4">
          APELLIDO
          <input id="apellido" name="apellido" type="text" class="form-control mayus" value="<?php print $apellido; ?>">
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-4">
          NOMBRES
          <input id="nombres" name="nombres" type="text" class="form-control mayus" value="<?php print $nombres; ?>">
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-4">
          CONDICION LABORAL
      ...
      <div class="row m-3">
        <div class="col-xs-12 col-sm-12 col-lg-4">
          DOMICILIO
          <input id="direccion" name="direccion" type="text" class="form-control mayus" value="<?php print $direccion; ?>">
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-4">
          E-MAIL
        ...
        <div class="col-xs-12 col-sm-12 col-lg-8">
          ...
          <div id="ciudad">
            <select name="id_ciudad" id="id_ciudad" size="1" class="form-control">
              <option value="<?php print $id_localidad; ?>" selected><?php print $localidad; ?>
              </option>
            </select>
          </div>
        </div>
      ...
      <div class="row m-3">
        <div class="col-xs-12 col-sm-12 col-lg-4">
          COD. AREA
          <input id="cod_area" name="cod_area" type="text" class="form-control" value="<?php print $cod_area; ?>">
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-4">
          CELULAR - Sin 15
          <input id="celular" name="celular" type="text" class="form-control" value="<?php print $celular; ?>">
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-4">
          FIJO
          <input id="telefono" name="telefono" type="text" class="form-control" value="<?php print $telefono; ?>">
        </div>
      </div>
      ...
      <div class="row m-3">
        <div class="col-xs-12 col-sm-12 col-lg-12">
          OBSERVACIONES
          <input id="observaciones" name="observaciones" type="text" class="form-control mayus" value="<?php print $observaciones; ?>">
        </div>
      </div>
