...
if($id_emprendedor == 0){
	...
	id_condicion_laboral = '$id_condicion_laboral', id_responsabilidad = '$id_responsabilidad', fecha_nac ='$fecha_nacimiento', observaciones='$observaciones' where id_emprendedor = '$id_emprendedor'";	
