...
$sql= "SELECT t1.id_solicitante, concat(t1.apellido, ', ', t1.nombres) AS solicitante, t1.direccion, t1.email, t1.dni,  t1.telefono, t1.celular, t4.nombre AS ciudad, t5.nombre AS dpto, t3.rubro, t6.id_programa, t7.abreviatura, t6.habilitado
...
LEFT JOIN (SELECT * FROM habilitaciones WHERE id_programa = 2) t6 ON t1.id_solicitante = t6.id_solicitante
LEFT JOIN tipo_programas t7 ON t6.id_programa = t7.id_programa
WHERE t1.id_responsabilidad = 1 AND t2.id_programa = 2";
