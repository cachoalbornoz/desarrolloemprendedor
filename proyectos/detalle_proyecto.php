...
if(isset($registro)){ 
  ...
  $dni            = '';	$apellido 	= '';	$nombres 	= '';	$direccion 	= '';	$email 		= '';
  $telefono       = '';	$celular 	= '';	$ciudad 	= '';	$id_ciudad	= 0;	$fecha_nac	= '';
  $id_departamento= 0;	$departamento	= '';	
}
...
if(isset($registro_proyectos)){
  ...
  // ACCEDER AL PROYECTO
  $denominacion = $registro_proyectos['denominacion'];	$resumen_ejecutivo = $registro_proyectos['resumen_ejecutivo'];	
  $monto = $registro_proyectos['monto'];
  $descripcion = $registro_proyectos['descripcion'];	$objetivos = $registro_proyectos['objetivos'];	$oportunidades = $registro_proyectos['oportunidades'];
  $desarrollo = $registro_proyectos['desarrollo'];	$historia = $registro_proyectos['historia'];	$presente = $registro_proyectos['presente'];
  $lugardesarrollo = $registro_proyectos['lugardesarrollo']; if($lugardesarrollo == 0){$lugardesarrollo = 'Alquilado';}else{$lugardesarrollo = 'Propio';}
  $detallelugar = $registro_proyectos['detallelugar'];	$caratecnicas = $registro_proyectos['caratecnicas'];
  $caratecnologicas = $registro_proyectos['caratecnologicas'];	$caraprocesos = $registro_proyectos['caraprocesos'];	$caramateriasprimas = $registro_proyectos['caramateriasprimas'];
  $caradesechos = $registro_proyectos['caradesechos'];	$mercado = $registro_proyectos['mercado'];	$caraclientes = $registro_proyectos['caraclientes'];
  $caracompetencia = $registro_proyectos['caracompetencia'];	$caraproveedores = $registro_proyectos['caraproveedores'];	$carariesgosestrategias = $registro_proyectos['carariesgosestrategias'];
  $destinomonto = $registro_proyectos['destinomonto'];	$personal = $registro_proyectos['personal'];	$interaccion = $registro_proyectos['interaccion']; $impacto = $registro_proyectos['impacto'];
  $preciosproductos = $registro_proyectos['preciosproductos'];	$origenfinanciacion = $registro_proyectos['origenfinanciacion'];	$fodafortalezas = $registro_proyectos['fodafortalezas'];
  $fodaoportunidades = $registro_proyectos['fodaoportunidades'];	$fodadebilidades = $registro_proyectos['fodadebilidades'];	$fodaamenazas = $registro_proyectos['fodaamenazas'];
  $latitud = $registro_proyectos['latitud'];	$longitud = $registro_proyectos['longitud']; $fnovedad = $registro_proyectos['fnovedad'];
  ...
  $denominacion = '';	$resumen_ejecutivo = '';	$monto = 0;	$descripcion = '';	$objetivos = '';	$oportunidades = '';	$desarrollo = '';
  $historia = '';	$presente = '';	$lugardesarrollo = 0;	$detallelugar = '';	$caratecnicas = '';	$caratecnologicas = '';	$caraprocesos = '';
  $caramateriasprimas = '';	$caradesechos = '';	$mercado = '';	$caraclientes = '';	$caracompetencia = '';	$caraproveedores = '';
  $carariesgosestrategias = '';	$destinomonto = '';	$personal = '';	$interaccion = '';	$impacto = '';	$preciosproductos = '';	$origenfinanciacion = '';
  $fodafortalezas = '';	$fodaoportunidades = '';	$fodadebilidades = '';	$fodaamenazas = '';		$latitud = 0;	$longitud = 0;   
...
if($id_empresa > 0){
  ...
  $tabla  = mysqli_query($con, "SELECT *
    ...
    INNER JOIN tipo_sociedad t2 ON t1.id_tipo_sociedad = t2.id_tipo
    WHERE id = $id_empresa");
...
<tr>
  <td>Teléfono Fijo <b>'. $telefono .'</b></td>
  <td>Móvil <b>'. $celular .'</b></td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr>
...
while($fila_otros = mysqli_fetch_array($registro_otros)){
      ...
      <tr>
        <td colspan="2">Domicilio <b>'. $fila_otros['direccion'].'</b></td>
        <td colspan="2">Ciudad <b>'. $fila_otros['ciudad'] .'</b> - Entre Ríos</td>
      </tr>
      <tr>
        <td>Teléfono Fijo <b>'. $fila_otros['telefono'] .'</b></td>
        <td>Móvil <b>'. $fila_otros['celular'] .'</b></td>
        <td></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
  ...
  $subtotal_ano1= 0;
	$total        = 0;
	$contador     = 1; 
  $registro_conceptos = mysqli_query($con, 
  ...
  <tr>
    ...
    <td align="center">'; if($fila_fuentes['ano'] == 1){ $html .= $fila_fuentes['monto']; }else{      $html .= '';          }    $html .=' </td>
    <td align="right">';  if($fila_fuentes['ano'] == 2){ $html .= $fila_fuentes['monto']; }else{      $html .= '';          }    $html .=' </td>
  </tr>
  ';
