    ...
    <div class="card-header">
        <div class="row mb-2">
            ...
            <div class="col-xs-12 col-sm-10 col-lg-10">
                TITULAR DEL PROYECTO :: # <?php print $id_solicitante; ?> - <b> <?php print $solicitante; ?></b>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <form action="agregar_expediente_f.php" method="post" name="expedientes" id="expedientes">
            ...
            <div class="row mb-5">
                <div class="col-xs-12 col-sm-2 col-lg-3">
                    Nro proyecto
                    <input type="text" name="nro_proyecto" id="nro_proyecto" value="<?php print $IdProyecto; ?>" class="form-control">
                </div>
                <div class="col-xs-12 col-sm-10 col-lg-6">
                    Rubro
                    <select name="id_rubro" id="id_rubro" size="1" class="form-control">
                        <option value="<?php print $IdRubro; ?>"><?php print $rubro; ?>
                        </option>
                    </select>
                </div>
                <div class="col-xs-12 col-sm-2 col-lg-3">
                    <input type="hidden" name="id_solicitante" id="id_solicitante" value="<?php print $id_solicitante; ?>" class="form-control" readonly>
                </div>
            </div>

            <div class="row mb-5">
                <div class="col-xs-12 col-sm-3 col-lg-3">
                    Nro expediente madre madre
                    <input type="number" name="nro_expediente_madre" id="nro_expediente_madre" class="form-control" maxlength="11" required autofocus>
                </div>
                <div class="col-xs-12 col-sm-3 col-lg-3">
                    Nro expediente control
                    <input type="number" name="nro_expediente_control" id="nro_expediente_control" class="form-control" maxlength="11" required>
                </div>
                <div class="col-xs-12 col-sm-3 col-lg-3">
                    Monto
            ...
            <div class="row mb-5">
                <div class="col-xs-12 col-sm-3 col-lg-6">
                    ...
                    <select name="id_localidad" size="1" id="id_localidad" class="form-control">
                        <option value="<?php print $IdLocalidad; ?>"><?php print $localidad; ?>
                        </option>
                    </select>
                </div>
                <div class="col-xs-12 col-sm-3 col-lg-6">
