...
<form action="editar_expediente.php?id=<?php print $id_expediente; ?>" method="post" name="expedientes" id="expedientes">
        ...
        <div class="card-header">
            <div class="row mb-2">
                <div class="col-xs-12 col-sm-6 col-lg-6">
                    <b><?php print $_SESSION['titular']; ?> </b> - Datos del Expediente
                </div>
                <div class="col-xs-12 col-sm-6 col-lg-6">
        ...
        <div class="card-body">
            ...
            <div class="row mb-5">
                <div class="col-xs-12 col-sm-2 col-lg-2">
                    Nro proyecto
                    <input type="text" name="nro_proyecto" id="nro_proyecto" autofocus value="<?php print $nro_proyecto; ?>" class="form-control" required>
                </div>

                <div class="col-xs-12 col-sm-10 col-lg-10">
                    Rubro
                    <select name="id_rubro" id="id_rubro" size="1" class="form-control">
                        <option value='<?php print $id_rubro; ?>'><?php print $rubro; ?>
                        </option>
                        <?php
            ...
            <div class="row mb-5">
                <div class="col-sm-3">
                    ...
                    <input type="text" name="nro_expediente_madre" id="nro_expediente_madre" value="<?php print $nro_expediente_madre; ?>" class="form-control" required>
                </div>
                <div class="col-sm-3 d-none">

                    Nro expediente control
                    <input type="text" name="nro_expediente_control" id="nro_expediente_control" value="<?php print $nro_expediente_control; ?>" class="form-control" required>

                </div>
                <div class="col-sm-3">
                    Monto
                    <input type="text" name="monto" id="monto" value="<?php print $monto; ?>" class="form-control" required>
                </div>

                <div class="col-sm-3">

                    Fecha otorgamiento
                    <input type="date" name="fecha_otorgamiento" id="fecha_otorgamiento" value="<?php print $fecha_otorgamiento; ?>" class="form-control" required>
            ...
            <div class="row mb-5">
                <div class="col-xs-12 col-sm-3 col-lg-6">
                    ...
                    <select name="id_localidad" size="1" id="id_localidad" class="form-control">
                        <option value="<?php print $id_localidad; ?>"><?php print $localidad; ?>
                        </option>
                        <?php
                        $con      = conectar();
